        ...
        useFormik({
            ...
            onSubmit: async (submittedValues) => {
                ...
                if (submittedValues.description) {
                    inputs.updateProductInput.value.description = submittedValues.description;
                }
                if (submittedValues.colorsHex && submittedValues.image) {
                    ...
                    inputs.updateProductInput.value.choices = submittedValues.choices.concat(arr);
                }
                UpdateRecordAction(
                    'updateProduct',
                    inputs,
        ...
        >
            <Form layout="vertical">
                ...
                <Form.Item
                    ...
                    name="description"
                >
                    <Input.TextArea name="description" onChange={handleChange} value={values.description} placeholder={values.description} />
                </Form.Item>
                <Form.Item
                    label="Price"
                    name={'price'}
                >
                    <Input name="price" onChange={handleChange} value={values.price} placeholder={values.price} />
                </Form.Item>
