        ...
        useFormik({
            ...
            onSubmit: async (submittedValues) => {
                ...
                if (submittedValues.redirectionType) {
                    inputs.createGlobalLinkInput.value.redirectionType = submittedValues.redirectionType;
                }
                if (submittedValues.placeholder) {
                    inputs.createGlobalLinkInput.value.placeholder = submittedValues.placeholder;
                }
