...
export const EditGlobalLink: React.FC<IResourceComponentsProps> = () => {
    ...
    useEffect(() => {
        if (refresh && params?.id) {
            showRecord('findGlobalLink-custom', params?.id, globalLniks, setRecord, setRefresh)
        }
    }, [refresh, params?.id])
        ...
        useFormik({
            ...
            onSubmit: async (submittedValues) => {
                ...
                if (submittedValues.redirectionType) {
                    inputs.updateGlobalLinkInput.value.redirectionType = submittedValues.redirectionType;
                }
                if (submittedValues.placeholder) {
                    inputs.updateGlobalLinkInput.value.placeholder = submittedValues.placeholder;
                }
    ...
    useEffect(() => {
        if (record) {
            ...
            setFieldValue('image', record?.image)
        ...
        >
            ...
            <Form layout="vertical">
                ...
                <Form.Item
                    ...
                    name="title"
                >
                    <Input name="title" onChange={handleChange} value={values.title} placeholder={values.title} />
                </Form.Item>
                <Form.Item
                    label="RedirectionType"
                ...
                <Form.Item
                    ...
                    name={'placeholder'}
                >
                    <Input name="placeholder" onChange={handleChange} value={values.placeholder} placeholder={values.placeholder} />
                </Form.Item>
                ...
                <Form.Item
                    ...
                    name={'Deleted'}
                >
                    <Switch onChange={(val) => setFieldValue('deleted', val)} defaultChecked={!!values?.deleted} />
                </Form.Item>
